 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://calc.com/", wsdlLocation = "http://127.0.0.1:8084/calc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://calc.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8084/calc?wsdl");
    ...
    public CalculatorImpl getCalculatorImplPort() {
        return super.getPort(new QName("http://calc.com/", "CalculatorImplPort"), CalculatorImpl.class);
    }
    ...
    public CalculatorImpl getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calc.com/", "CalculatorImplPort"), CalculatorImpl.class, features);
    }
